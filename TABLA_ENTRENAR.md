contratos_digitalizados 
    ...
    | **E**  | Altos del Prado / Finca Las Lomas | Anexo 1 — VIII. FIRMA DEFINITIVO | Campo: **"Fecha de firma de contrato definitivo"** (Es la fecha de Entrega) | `30/06/2027`                  |
    ...
    ⚠️ La frase "se realizará en la fecha indicada en el Anexo 1" obliga a buscar en los cuadros del final (Patrón D o E).
    ⚠️ IMPORTANTE: **"Fecha de firma de contrato definitivo"** en el Anexo 1 = **Fecha Pactada Entrega**.
